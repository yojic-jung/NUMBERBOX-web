import { nb_S3ImgToBase64, nb_postRequest } from 'js/common/common_nb.js';

//수식 변수명 중복으로 여러개 등록되어있는 것 고유화 작업
const inAccurateNbBoxesList = [
  {
    formulType: 'nbArrowBox',
    subTypeA: 'nbRightArrowBase',
    toTypeA: 'nbRightArrowBox',
    subTypeB: 'nbArcBase',
    toTypeB: 'nbArcBox',
    subTypeC: 'nbBiDirArrowBase',
    toTypeC: 'nbBiDirArrowBox',
  },
...
const nbToTexConvert = [
  ...
  {
    formulType: 'nbSigmaSumBox',
    toTex: ' sum _{' + 'val2Point' + '} ^{' + 'val3Point' + '} ' + 'val1Point',
    val1Class: 'nbSigmaSumBase',
    val2Class: 'nbSigmaSumSub',
    val3Class: 'nbSigmaSumSup',
  },
  ...
  {
    formulType: 'nbBiDirSubBox',
    toTex: ' {}_{' + 'val2Point' + '} rm' + 'val1Point' + ' {}_{' + 'val3Point' + '} it',
    val1Class: 'nbBiDirSubBase',
    val2Class: 'nbLeftSub',
    val3Class: 'nbRightSub',
  },
  ...
  {
    formulType: 'nbIntegralBox',
    toTex: ' int _{' + 'val2Point' + '} ^{' + 'val3Point' + '} {' + 'val1Point' + '}',
    val1Class: 'nbIntBase',
    val2Class: 'nbIntSub',
    val3Class: 'nbIntSup',
  },
  {
    formulType: 'nbDoubleIntegralBox',
    toTex: ' dint _{' + 'val2Point' + '} ^{' + 'val3Point' + '} {' + 'val1Point' + '}',
    val1Class: 'nbDoubleIntBase',
    val2Class: 'nbDoubleIntSub',
    val3Class: 'nbDoubleIntSup',
  },
  {
    formulType: 'nbTripleIntegralBox',
    toTex: ' tint _{' + 'val2Point' + '} ^{' + 'val3Point' + '} {' + 'val1Point' + '}',
    val1Class: 'nbTripleIntBase',
    val2Class: 'nbTripleIntSub',
    val3Class: 'nbTripleIntSup',
  },
  ...
  {
    formulType: 'nbIntBrckBox',
    toTex: ' LEFT [ ' + 'val1Point' + ' RIGHT ] _{' + 'val2Point' + '} ^{' + 'val3Point' + '}',
    val1Class: 'nbIntBrckBase',
    val2Class: 'nbIntBrckSubBase',
    val3Class: 'nbIntBrckSupBase',
  },
  ...
  {
    formulType: 'nbThrCasekBox',
    toTex: ' {cases {' + 'val1Point' + '#' + 'val2Point' + '#' + 'val3Point' + '}}',
    val1Class: 'nbThrCaseFir',
    val2Class: 'nbThrCaseSec',
    val3Class: 'nbThrCaseThr',
  },
];
...
export const replaceTexToNbFormul = [
...
export const cvt_convertHtmlToTex = (contentsDiv) => {
    ...
    for (let i = 0; i < nbBoxes.length; i++) {
      ...
      InnerLoop: for (let j = 0; j < nbToTexConvert.length; j++) {
        if (nbBoxes[i].classList.contains(nbToTexConvert[j].formulType)) {
          ...
          if (
            nbToTexConvert[j].formulType === 'nb-R-BrckBox' ||
            nbToTexConvert[j].formulType === 'nb-C-BrckBox' ||
            nbToTexConvert[j].formulType === 'nb-S-BrckBox' ||
            nbToTexConvert[j].formulType === 'nb-Abs-BrckBox'
          ) {
  ...
  while (allDivDom.length > 0) {
    ...
    if (
      allDivDom[0].querySelectorAll('div').length === 0 &&
      allDivDom[0].innerText.length !== 0 &&
      (allDivDom[0].lastElementChild === null ||
        ...
        (allDivDom[0].lastElementChild !== null &&
          allDivDom[0].lastElementChild.nodeName === 'BR' && //마지막 element가 br이여도 그 다음에 텍스트 노드가 오는 경우 있음 이때는 div 뒤에 br 추가 필요
          allDivDom[0].lastElementChild.nextSibling !== null &&
          allDivDom[0].lastElementChild.nextSibling.nodeName === '#text' &&
          allDivDom[0].lastElementChild.nextSibling.length > 0) ||
        (allDivDom[0].lastElementChild !== null &&
          allDivDom[0].lastElementChild.classList.contains('editInnerTable') && //마지막 element가 br이여도 그 다음에 텍스트 노드가 오는 경우 있음 이때는 div 뒤에 br 추가 필요
          allDivDom[0].lastElementChild.nextSibling !== null &&
          allDivDom[0].lastElementChild.nextSibling.nodeName === '#text' &&
          allDivDom[0].lastElementChild.nextSibling.length > 0))
    ) {
...
export const cvt_makeJsonForHwp = async (innerContents) => {
  ...
  if (innerContents.nodeName === '#text') {
    ...
    for (let j = 0; j < innerContents.nodeValue.length; j++) {
      ...
      if (
        engCheck.test(innerContents.nodeValue.charAt(j)) ||
        numCheck.test(innerContents.nodeValue.charAt(j)) ||
        fomulCheck1.test(innerContents.nodeValue.charAt(j)) ||
        fomulCheck2.test(innerContents.nodeValue.charAt(j)) ||
        fomulCheck3.test(innerContents.nodeValue.charAt(j)) ||
        fomulCheck4.test(innerContents.nodeValue.charAt(j))
      ) {
        if (j === 0) {
...
export const cvt_convertFracTexToHtml = async (texGrammer, texIndex, nbFormulHTML) => {
  ...
  //null나왔을 때 리턴 처리
  if (rightBrckIdx.strtBrckIdx === null || rightBrckIdx.endBrckIdx === null || leftBrckIdx.strtBrckIdx === null || leftBrckIdx.endBrckIdx === null) {
    return null;
  }
    ...
    if (leftBrckTex !== 'LEFT[') {
      ...
      if (texGrammer.substr(leftRightIdx.endBrckIdx + 6, 2) === '_{') {
        ...
        if (texGrammer.substr(rightUnderBrckIdx.endBrckIdx + 1, 2) === '^{') {
          ...
          let convertNbFormulBox = document.createElement('span');
          convertNbFormulBox.innerHTML =
            '<table class="nbIntBrckBox nbBox"><tbody class="nbIntBrckTbody"><tr><td class="nbIntBrckBase borderBox"><br></td></tr></tbody><tbody class="nbIntBrckTbody2"><tr><td class="nbIntBrckSupBase borderBox"><br></td></tr><tr><td class="nbIntBrckSubBase borderBox"><br></td></tr></tbody></table>';
    ...
    if (leftBrckTex === 'LEFT{') {
      if (texGrammer.substring(texIndex + 5, leftRightIdx.endBrckIdx).indexOf('#') > -1) {
        ...
        if (innerTexGrm.length === 2) {
          ...
          let convertNbFormulBox = document.createElement('span');
          convertNbFormulBox.innerHTML =
            '<table class="nbCaseBrckBox nbBox" ><tbody><tr><td rowspan="2" class="nbCaseBrck writeDisable borderBox">{</td><td class="nbCaseFir borderBox"><br></td></tr><tr><td class="nbCaseSec borderBox"><br></td></tr></tbody></table>';

          convertNbFormulBox.querySelector('.nbCaseFir').innerText = innerTexGrm[0]
            .replaceAll('&gt;', '임시꺽새변형999')
            .replaceAll('&lt;', '임시변형888')
            .replaceAll('&', '&nbsp;')
            .replaceAll('임시꺽새변형999', '&gt;')
            .replaceAll('임시변형888', '&lt;');
          convertNbFormulBox.querySelector('.nbCaseSec').innerText = innerTexGrm[1]
            .replaceAll('&gt;', '임시꺽새변형999')
            .replaceAll('&lt;', '임시변형888')
            .replaceAll('&', '&nbsp;')
            .replaceAll('임시꺽새변형999', '&gt;')
          ...
          let convertNbFormulBox = document.createElement('span');
          convertNbFormulBox.innerHTML =
            '<table class="nbThrCasekBox nbBox"><tbody><tr><td rowspan="3" class="nbThrCaseBrck writeDisable borderBox">{</td><td class="nbThrCaseFir borderBox"><br></td></tr><tr><td class="nbThrCaseSec borderBox"><br></td></tr><tr><td class="nbThrCaseThr borderBox"><br></td></tr></tbody></table>';

          convertNbFormulBox.querySelector('.nbThrCaseFir').innerText = innerTexGrm[0]
            .replaceAll('&gt;', '임시꺽새변형999')
            .replaceAll('&lt;', '임시변형888')
            .replaceAll('&', '&nbsp;')
            .replaceAll('임시꺽새변형999', '&gt;')
            .replaceAll('임시변형888', '&lt;');
          convertNbFormulBox.querySelector('.nbThrCaseSec').innerText = innerTexGrm[1]
            .replaceAll('&gt;', '임시꺽새변형999')
            .replaceAll('&lt;', '임시변형888')
            .replaceAll('&', '&nbsp;')
            .replaceAll('임시꺽새변형999', '&gt;')
            .replaceAll('임시변형888', '&lt;');
          convertNbFormulBox.querySelector('.nbThrCaseThr').innerText = innerTexGrm[2]
            .replaceAll('&gt;', '임시꺽새변형999')
            .replaceAll('&lt;', '임시변형888')
            .replaceAll('&', '&nbsp;')
            .replaceAll('임시꺽새변형999', '&gt;')
...
export const cvt_convertSigmaSumTexToHtml = async (texGrammer, texIndex, nbFormulHTML) => {
  ...
  //null나왔을 때 리턴 처리
  if (underBarBrckIdx.strtBrckIdx === null || underBarBrckIdx.endBrckIdx === null || hatBrckIdx.strtBrckIdx === null || hatBrckIdx.endBrckIdx === null) {
    return null;
  }
...
export const cvt_convertIntegralTexToHtml = async (texGrammer, texIndex, nbFormulHTML, integralType) => {
  ...
  //null나왔을 때 리턴 처리
  if (
    underBarBrckIdx.strtBrckIdx === null ||
    underBarBrckIdx.endBrckIdx === null ||
    hatBrckIdx.strtBrckIdx === null ||
    hatBrckIdx.endBrckIdx === null ||
    intBaseBrckIdx.strtBrckIdx === null ||
    intBaseBrckIdx.endBrckIdx === null
  ) {
    return null;
  }
...
export const cvt_convertLimTexToHtml = async (texGrammer, texIndex, nbFormulHTML) => {
  ...
  //null나왔을 때 리턴 처리
  if (underBarBrckIdx.strtBrckIdx === null || underBarBrckIdx.endBrckIdx === null || baseBrckIdx.strtBrckIdx === null || baseBrckIdx.endBrckIdx === null) {
    return null;
  }
...
export const cvt_convertExpRootTexToHtml = async (texGrammer, texIndex, nbFormulHTML) => {
  ...
  //null나왔을 때 리턴 처리
  if (rootExpIdx.strtBrckIdx === null || rootExpIdx.endBrckIdx === null || rootBaseIdx.strtBrckIdx === null || rootBaseIdx.endBrckIdx === null) {
    return null;
  }
...
export const cvt_convertLogTexToHtml = async (texGrammer, texIndex, nbFormulHTML) => {
  ...
  if (texGrammer.substr(texIndex + 3, 2) === '_{') {
    //있으면 로그박스 생성
...
export const cvt_convertCasesTexToHtml = async (texGrammer, texIndex, nbFormulHTML) => {
  ...
  if (casesStr.length === 2) {
    //연립방정식 2가지 경우
    convertNbFormulBox.querySelector('.nbCaseFir').innerText = casesStr[0]
      .replaceAll('&gt;', '임시꺽새변형999')
      .replaceAll('&lt;', '임시변형888')
      .replaceAll('&', '&nbsp;')
      .replaceAll('임시꺽새변형999', '&gt;')
      .replaceAll('임시변형888', '&lt;');
    convertNbFormulBox.querySelector('.nbCaseSec').innerText = casesStr[1]
      .replaceAll('&gt;', '임시꺽새변형999')
      .replaceAll('&lt;', '임시변형888')
      .replaceAll('&', '&nbsp;')
      .replaceAll('임시꺽새변형999', '&gt;')
    ...
    convertNbFormulBox.querySelector('.nbThrCaseFir').innerText = casesStr[0]
      .replaceAll('&gt;', '임시꺽새변형999')
      .replaceAll('&lt;', '임시변형888')
      .replaceAll('&', '&nbsp;')
      .replaceAll('임시꺽새변형999', '&gt;')
      .replaceAll('임시변형888', '&lt;');
    convertNbFormulBox.querySelector('.nbThrCaseSec').innerText = casesStr[1]
      .replaceAll('&gt;', '임시꺽새변형999')
      .replaceAll('&lt;', '임시변형888')
      .replaceAll('&', '&nbsp;')
      .replaceAll('임시꺽새변형999', '&gt;')
      .replaceAll('임시변형888', '&lt;');
    convertNbFormulBox.querySelector('.nbThrCaseThr').innerText = casesStr[2]
      .replaceAll('&gt;', '임시꺽새변형999')
      .replaceAll('&lt;', '임시변형888')
      .replaceAll('&', '&nbsp;')
      .replaceAll('임시꺽새변형999', '&gt;')
    ...
    convertNbFormulBox.querySelector('.nbThrCaseThr').innerText =
      casesStr[2]
        .replaceAll('&gt;', '임시꺽새변형999')
        .replaceAll('&lt;', '임시변형888')
        .replaceAll('&', '&nbsp;')
        .replaceAll('임시꺽새변형999', '&gt;')
        .replaceAll('임시변형888', '&lt;') + additionalCases;
...
export const cvt_htmlToTexAll = async (rootId, subClassName, title, owner, isSolHide) => {
  ...
  for (let idx = 0; idx < workListTable.length; idx++) {
    ...
    let contentsArr = [
      ...
      { className: 'solContents', title: '' },
      { className: 'quesContents', title: '' },
