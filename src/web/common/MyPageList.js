            ...
            <>
                <div className="myPageMenuDIv">
                    <div className="myPageMenuWrap">
                        ...
                        <Link className='linkNoneCss' to="/myMathDocs?pageNum=1"><span id="myMathDocs" className="myPageMenu"><span className="myPageMenuTitle myDocs">학습지</span></span></Link>
                        <Link className='linkNoneCss' to="/myResource?pageNum=1"><span id="myResource" className="myPageMenu"><span className="myPageMenuTitle myResource">컨텐츠</span></span></Link>
                    </div>
                </div>
            </>
