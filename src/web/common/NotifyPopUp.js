...
const NotifyPopUp = ()=>{
    return (
        <div id="notifyPopupWrap"  className='blindBox'>
            <div className='notifyPopup'>
                <div className="closeBtn errCloseBtn" onClick={()=>{document.getElementById("notifyPopupWrap").classList.add("hide")}}>X</div>
                <div>
                    <div className='notifyPopupTitle'><b>[공지] N명의수학 서비스 종료 안내</b></div>
                    <br/>
                    <div className='notifyPopupContents'>
                        <div>안녕하세요. N명의수학입니다.</div>
