          ...
          <div className='bi-jutify-align'>
            <div className={titleClass}>
              <Link className='linkNoneCss' to='/'>
                N명<span className='menu-title-etc2'>의</span>수학
              </Link>
            </div>
              ...
              <table className='menu-list-table'>
                <tbody>
                  {!isLogin && (
                    <tr>
                      <td>
                        <Link className='linkNoneCss' to='/makeMathDocs'>
                          학습지생성
                        </Link>
                      </td>
                      <td>
                        <Link className='linkNoneCss' to='/contentsList'>
                          문제검색
                        </Link>
                      </td>
                      <td>
                      ...
                      <td>
                        <Link className='linkNoneCss signLoginBtn' to='/login'>
                          로그인/회원가입
                        </Link>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      >
                        ...
                        <ul className='myService-list hide'>
                          <Link className='linkNoneCss' to='/myProfile'>
                            <li>프로필</li>
                          </Link>
                          <Link className='linkNoneCss' to='/myContentsList'>
                            <li>나의 제작문제</li>
                          </Link>
              ...
              <div>
                <table className='menu-list-table'>
                  <tbody>
                    <tr>
                      <td>
                        <Link className='manager-link' to='/admin/adminMenuBar'>
                          관리자 메뉴
                        </Link>
                      </td>
                    </tr>
