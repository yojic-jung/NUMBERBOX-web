...
const MyAccountDrop = () => {
  ...
  const myAccountDrop = async () => {
    ...
    if (returnVal.isSuccess) {
      alert(
        '탈퇴 요청이 정상 처리되었습니다. 14~15일 이후 정상적으로 탈퇴 처리됩니다.\n탈퇴를 취소하고 싶은 경우 재 로그인하면 자동 취소 됩니다.'
      );
    ...
    <>
      ...
      <div className='myProfileWrap'>
        ...
        <div className='mini-title3'>
          N명의수학 서비스를 이용하시는데 불편함이 있으셨나요?
        </div>
        <div className='mini-title3'>
          이용 불편 및 각종 문의 사항은 고객센터로 문의 주시면 적극적으로
          해결하고 이에 대한 성심 성의있는 답변 드리겠습니다.
        </div>
        <div className='myAccountDropDiv'>
          <div className='myAccountDropTitle'>
            회원 탈퇴 전 , 유의사항을 확인해 주시기 바랍니다.
          </div>
          <ul>
            <li>
              회원 탈퇴는 탈퇴 요청 후 14~15일 후에 처리됩니다. 14~15일 이전에
              로그인 한 경우 자동으로 탈퇴 요청은 취소 됩니다.
            </li>
            <li>
              N명의수학에서 저작물(ex. 제작문제)을 생산하고 이 저작물에 대해
              다른 사용자가 2차 저작물(ex. 변형문제)을 생산한 경우 원본 저작물에
              대한 라이선스 정보는 삭제되지 않습니다.
              <br />
              (2차 저작물 생산 사용자에게는 원본문제의 저작권이 여전히 원본문제
              제작자에게 존재함이 표시됩니다.)
            </li>
            <li>
              회원 탈퇴 처리 후 N명의수학에 저장 되어있는 사용자의 개인정보는
              모두 파기됩니다.
            </li>
            <li>
              탈퇴 이후 탈퇴한 회원의 이메일로는 계정을 만들 수 없습니다. 서비스
              탈퇴 후 재 가입을 원할시 새로운 이메일 계정으로 가입하여 서비스를
              이용 바랍니다.
            </li>
          </ul>
        </div>
        <div className='myAccountDropAgree'>
          <input id='dropAgreeCheck' type='checkbox' />
          상기 회원탈퇴 처리사항 안내를 확인하고 이에 동의합니다.
        </div>
        <div className='myAccountDropDiv2'>
          <div>
            보안을 위해 회원님의 이름, 계정 이메일 및 비밀번호를 한번 더
            확인합니다.
          </div>
            ...
            <table className='myAccountDropTb'>
              <tbody>
                <tr>
                  ...
                  <td>
                    <span className='customBtn' onClick={() => myAccountDrop()}>
                      탈퇴요청
                    </span>
                  </td>
                </tr>
