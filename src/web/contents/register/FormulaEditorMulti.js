...
import {reg_mDownTdWidthChange, reg_mUpTdWidthChange, reg_formulaTapMoveEv, reg_convertSpanToNoTag, reg_removeStyleAttribute,
		reg_mMoveTdWidthChange, reg_selStartTdWidthChange, reg_undoRedoSetting,
		reg_newSelectFormulaElement,  reg_removeSelectionBackColor, reg_tbCellMouseUp, reg_tbCellCopy, reg_tbSelBackgroundRemove, 
		reg_undoRedoInitialize, reg_enableImageResizeInDiv, reg_removeResizeFrame} from 'js/contents/register/contents_reg';
...
const FormulaEditorMulti = ({contentsClassify}) => {
	...
	const formulaEditor = [{id:"contentsRootDiv1", ordinalNum:"1st", className:""},{id:"contentsRootDiv2",ordinalNum:"2nd", className:"hide"},{id:"contentsRootDiv3", ordinalNum:"3rd", className:"hide"},{id:"contentsRootDiv4", ordinalNum:"4th", className:"hide"}
	,{id:"contentsRootDiv5", ordinalNum:"5th", className:"hide"},{id:"contentsRootDiv6", ordinalNum:"6th", className:"hide"},{id:"contentsRootDiv7", ordinalNum: "7th", className:"hide"},{id:"contentsRootDiv8", ordinalNum: "8th", className:"hide"},{id:"contentsRootDiv9", ordinalNum: "9th", className:"hide"},{id:"contentsRootDiv10", ordinalNum: "10th", className:"hide"}
	,{id:"contentsRootDiv11", ordinalNum:"11th", className:"hide"},{id:"contentsRootDiv12",  ordinalNum: "12th", className:"hide"},{id:"contentsRootDiv13", ordinalNum: "13th", className:"hide"},{id:"contentsRootDiv14", ordinalNum: "14th", className:"hide"},{id:"contentsRootDiv15", ordinalNum: "15th", className:"hide"},{id:"contentsRootDiv16", ordinalNum: "16th", className:"hide"}
	,{id:"contentsRootDiv17", ordinalNum:"17th", className:"hide"},{id:"contentsRootDiv18", ordinalNum: "18th", className:"hide"},{id:"contentsRootDiv19", ordinalNum: "19th", className:"hide"},{id:"contentsRootDiv20", ordinalNum: "20th", className:"hide"},{id:"contentsRootDiv21", ordinalNum: "21th", className:"hide"},{id:"contentsRootDiv22", ordinalNum: "22th", className:"hide"}
	...
	useEffect(() => {
		const asyncUseEffect = async function(){
			...
			let returnObj = await nb_dataFetch('/mathInfo/unitInfo', true);
	...
	const contentsValidation = async function(){
		...
		for(let i=0; i<contentsRootDiv.length; i++){
			...
			let isFirNoExist =  false, isSecNoExist =  false, isThrNoExist =  false, isFourNoExist = false, isFifNoExist = false;
			...
			for(let j=0; j<contentEditClass.length; j++){
				if(contentEditClass[j].classList.contains("contentsFormulaEditor")){
					...
					if(contentEditClass[j].id.indexOf("firNoFormulaEditor")>-1){
						isFirNoExist = ((!(contentEditClass[j].innerText.length ===1 && contentEditClass[j].innerText === "\n") && contentEditClass[j].innerText.length > 0) || contentEditClass[j].querySelector("img") !== null);

					}else if(contentEditClass[j].id.indexOf("secNoFormulaEditor")>-1){
						isSecNoExist = ((!(contentEditClass[j].innerText.length ===1 && contentEditClass[j].innerText === "\n") && contentEditClass[j].innerText.length > 0) || contentEditClass[j].querySelector("img") !== null);

					}else if(contentEditClass[j].id.indexOf("thrNoFormulaEditor")>-1){
						isThrNoExist = ((!(contentEditClass[j].innerText.length ===1  && contentEditClass[j].innerText === "\n") && contentEditClass[j].innerText.length > 0) || contentEditClass[j].querySelector("img") !== null);

					}else if(contentEditClass[j].id.indexOf("fourNoFormulaEditor")>-1){
						isFourNoExist = ((!(contentEditClass[j].innerText.length ===1 && contentEditClass[j].innerText === "\n") && contentEditClass[j].innerText.length > 0) || contentEditClass[j].querySelector("img") !== null);

					}else if(contentEditClass[j].id.indexOf("fifNoFormulaEditor")>-1){
						isFifNoExist = ((!(contentEditClass[j].innerText.length ===1 && contentEditClass[j].innerText === "\n") && contentEditClass[j].innerText.length > 0) || contentEditClass[j].querySelector("img") !== null);
					}
				}
			...
			if(contentsClassify === 4){
				...
				if(currentContentsDiv.querySelector("#impMonth").value.length === 0 || currentContentsDiv.querySelector("#impMonth").value < 1 ||currentContentsDiv.querySelector("#impMonth").value > 12){
					alert("시행월을 입력해주세요.")
  ...
  return (
	  <>
		<div className="rightAbsolBox marginTen">
			<div id="saveBtn" className="nabyBox fixed" onClick={()=>{contentsValidation()}}>저장하기</div>
		</div>
