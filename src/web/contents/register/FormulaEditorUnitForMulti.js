...
const FormulaEditorUnitForMulti = ({ contentsClassify, customId, ordinalNum, classNames, idx, mathUnitInfo }) => {
  ...
  const multiChoiceImageFile = async (event) => {
    if (event.target.files[0] !== undefined) {
      ...
      event.target
        .closest('.multiChoiceBox')
        .querySelector('#' + multiImgTargetId)
        .append(img);
  ...
  return (
    <>
      {ordinalNum !== '1st' && <div className={'contentsRootPaddingDiv ' + classNames}></div>}
      <div id={customId} className={'contentsRootDiv multiContents ' + classNames}>
        <div className='contentsInfo-multi'>
          <div className='contentsInfo-idx'>{ordinalNum}</div>
          <div className='mini-title10'>단원/유형 정보</div>
          <select
            id='subject'
            name={'mathContents[' + idx + '].subject'}
            className='customBlueBox marginFive'
            onChange={(event) => {
              selChanged(event);
              initSecUnitOptBox(event);
              removeRedBoxValid(event);
            }}>
          ...
          <select
            id='secUnit'
            name={'mathContents[' + idx + '].secUnit'}
            className='customBlueBox marginFive'
            onChange={(event) => {
              selChanged(event);
              initThrUnitOptBox(event);
              removeRedBoxValid(event);
            }}>
          ...
          <select
            id='thrUnit'
            name={'mathContents[' + idx + '].thrUnit'}
            className='customBlueBox marginFive'
            onChange={(event) => {
              selChanged(event, 'thrUnit');
              fetchTypeInfo(event);
              removeRedBoxValid(event);
            }}>
          ...
          <select
            id='quesType'
            name={'mathContents[' + idx + '].quesType'}
            className='customBlueBox marginFive'
            onChange={(event) => {
              selChanged(event, 'quesType');
              removeRedBoxValid(event);
            }}>
          ...
          {contentsClassify === 'UserCustom' && (
            <>
              <select
                id='quesLevel'
                name={'mathContents[' + idx + '].quesLevel'}
                className='customBlueBox marginFive'
                onChange={(event) => {
                  selChanged(event);
                  removeRedBoxValid(event);
              ...
              <div id='licenseRootDiv'>
                <div className='mini-title10'>
                  ...
                  {ordinalNum === '1st' && (
                    <span
                      id='shareSttsAllCheck'
                      className='allCheckBtn'
                      onClick={(event) => {
                        allCheckFunction(event, 'shareSttsSuccess', 'shareSttsPublic', undefined, 'nbCustomSelected2');
                      }}>
                      일괄적용
                        ...
                        <td>
                          <label className='licChkBtn'>
                            <input
                              ...
                              type='radio'
                              value='1'
                              name={'mathContents[' + idx + '].shareStts'}
                              className='licensePublicBtn'
                              onChange={(event) => {
                                shareSttsChange(event, true);
                              }}
                            />
                  ...
                  <div id='licOptDiv' className='lowerOpacity'>
                    <div className='licDivFir'>
                      <label className='licChkBtn'>
                        ...
                        <span className='licChkBtnDesc'>
                          외부 동영상 플랫폼에서 출처 표시 하에
                          <br />
                          문제 사용 및 노출 허용
                        </span>
                      </label>
          ...
          {contentsClassify === 'Ipsi' && (
            <>
              <div className='mini-title10'>
                ...
                {ordinalNum === '1st' && (
                  <span
                    id='manageInsAllCheck'
                    className='allCheckBtn'
                    onClick={(event) => {
                      removeRedBoxValid(event);
                      allCheckFunction(event, 'manageInsSuccess', 'manageIns', undefined, 'nbCustomSelected2');
                    }}>
                    일괄적용
                    <div id='manageInsSuccess' className='allCheckBtnSuccess'>
                      일괄적용 완료
                    </div>
              ...
              <select
                id='manageIns'
                name={'mathContents[' + idx + '].manageIns'}
                className='customBlueBox marginFive'
                onChange={(event) => {
                  selChanged(event);
                  removeRedBoxValid(event);
              ...
              <div className='mini-title10'>
                ...
                {ordinalNum === '1st' && (
                  <span
                    id='paperTypeAllCheck'
                    className='allCheckBtn'
                    onClick={(event) => {
                      removeRedBoxValid(event);
                      allCheckFunction(event, 'paperTypeSuccess', 'paperType', undefined, 'nbCustomSelected2');
                    }}>
                    일괄적용
                    <div className='allCheckBtnDesc long'>모든 문항에 가/나형 구분 일괄적용</div>
                    <div id='paperTypeSuccess' className='allCheckBtnSuccess'>
                      일괄적용 완료
                    </div>
                  </span>
                )}
              ...
              <select
                id='paperType'
                name={'mathContents[' + idx + '].paperType'}
                className='customBlueBox marginFive'
                onChange={(event) => {
                  selChanged(event);
                  removeRedBoxValid(event);
              ...
              <div className='mini-title10'>
                ...
                {ordinalNum === '1st' && (
                  <span
                    id='impYearMonthAllCheck'
                    className='allCheckBtn'
                    onClick={(event) => {
                      allCheckFunction(event, 'impSuccess', 'impYear', 'impMonth', 'customBlueBoxComplete');
                    }}>
                    일괄적용
                    <div className='allCheckBtnDesc'>모든 문항에 시행연월 일괄적용</div>
                    <div id='impSuccess' className='allCheckBtnSuccess'>
                      일괄적용 완료
                    </div>
                  </span>
                )}
              ...
              <input
                id='impYear'
                name={'mathContents[' + idx + '].impYear'}
                type='number'
                className='alignCenter impYear customBlueBox marginFive'
                onBlur={(event) => nb_completeBlueBoxMulti(event, 1)}
                onKeyUp={(event) => removeRedBoxValid(event)}
                placeholder='연도'
              />
              년
              <input
                id='impMonth'
                name={'mathContents[' + idx + '].impMonth'}
                type='number'
                className='alignCenter impMonth customBlueBox marginFive'
                onBlur={(event) => nb_completeBlueBoxMulti(event, 1)}
                onKeyUp={(event) => removeRedBoxValid(event)}
                placeholder='월'
              />
              ...
              <span className='mini-title11 paddingLTen'>홀</span>{' '}
              <input
                id='oddQuesNum'
                name={'mathContents[' + idx + '].oddQuesNum'}
                type='number'
                onBlur={(event) => nb_completeBlueBoxMulti(event, 1)}
                onKeyUp={(event) => removeRedBoxValid(event)}
                className='alignCenter oddQuesNum customBlueBox'
                placeholder='홀수형'
              />
              &nbsp;<span className='mini-title11 hide'>짝</span>{' '}
              <input
                id='evenQuesNum'
                defaultValue={0}
                name={'mathContents[' + idx + '].evenQuesNum'}
                type='number'
                onBlur={(event) => nb_completeBlueBoxMulti(event, 1)}
                onKeyUp={(event) => removeRedBoxValid(event)}
                className='alignCenter evenQuesNum customBlueBox hide'
                placeholder='짝수형'
              />
              <br />
              <div className='mini-title10'>
                ...
                <select
                  id='quesLevel'
                  name={'mathContents[' + idx + '].quesLevel'}
                  className='customBlueBox marginFive multi'
                  onChange={(event) => {
                    selChanged(event);
                    removeRedBoxValid(event);
                  }}>
              ...
              <div className='mini-title10'>
                ...
                <input
                  id='wrongRatio'
                  name={'mathContents[' + idx + '].wrongRatio'}
                  type='number'
        ...
        <div>
          ...
          <div className='twoGrid'>
            <div
              id={'contentsFormulaEditor' + ordinalNum}
              className='contentsFormulaEditor contentEditClass onlyEdit multi'
              ...
              onKeyDown={(event) => {
                ...
                copyPreventEv(event);
                multiChoicDefaultSetFunc(event);
              }}
              onKeyUp={(event) => {
                ...
                reg_convertFigureTagRemove('contentsFormulaEditor' + ordinalNum);
                removeRedBoxValid(event);
                multiChoicDefaultSetFunc(event);
              }}
              onClick={() => {
            ...
            <div
              id={'solutionFormulaEditor' + ordinalNum}
              className='solutionFormulaEditor contentEditClass onlyEdit multi'
              contentEditable='true'
              spellCheck={false}
              ...
              onKeyUp={(event) => {
                ...
                reg_nbComplie(event);
                nb_base64ImgRegisterToS3(event);
                reg_convertFigureTagRemove('solutionFormulaEditor' + ordinalNum);
              }}
          ...
          <div className='twoGrid'>
            <div
              id='contentsOptBox'
              className='contentsOptBox marginTen'
              onClick={(event) => {
                removeRedBoxValidAll(event);
              }}>
              <div className='mini-title marginBox hide'></div>
              ...
              <div id='multiChoiceBox' className='multiChoiceBox'>
                ...
                <div className='multiChoiceWrap'>
                  <div
                    id={'firNoFormulaEditor' + ordinalNum}
                    contentEditable='true'
                    spellCheck={false}
                    className='multiChoiceView contentEditClass onlyEdit multi'
                    onKeyDown={(event) => {
                      reg_preventKeyEvent(event, isMyContents);
                      copyPreventEv(event);
                    }}
                    onKeyUp={(event) => {
                      ...
                      reg_nbComplie(event);
                      nb_base64ImgRegisterToS3(event);
                      reg_convertFigureTagRemove('firNoFormulaEditor' + ordinalNum);
                      removeRedBoxValidAll(event);
                    }}
                    onClick={() => reg_dressYellowBox()}
                    onMouseDown={() => {
                  ...
                  <div
                    ...
                    onClick={(event) => {
                      multiChoiceImgAdd('firNoFormulaEditor' + ordinalNum, event);
                    }}></div>
                </div>
                <div className='multiChoiceWrap'>
                  <div
                    id={'secNoFormulaEditor' + ordinalNum}
                    contentEditable='true'
                    spellCheck={false}
                    className='multiChoiceView contentEditClass onlyEdit multi'
                    onKeyDown={(event) => {
                    ...
                    onKeyUp={(event) => {
                      ...
                      reg_nbComplie(event);
                      nb_base64ImgRegisterToS3(event);
                      reg_convertFigureTagRemove('secNoFormulaEditor' + ordinalNum);
                      removeRedBoxValidAll(event);
                    }}
                    onClick={() => reg_dressYellowBox()}
                    onMouseDown={() => {
                  ...
                  <div
                    className='multiChoiceImgAddBtn'
                    onClick={(event) => {
                      multiChoiceImgAdd('secNoFormulaEditor' + ordinalNum, event);
                    }}></div>
                </div>
                <div className='multiChoiceWrap'>
                  <div
                    id={'thrNoFormulaEditor' + ordinalNum}
                    contentEditable='true'
                    spellCheck={false}
                    className='multiChoiceView contentEditClass onlyEdit multi'
                    onKeyDown={(event) => {
                    ...
                    onKeyUp={(event) => {
                      ...
                      reg_nbComplie(event);
                      nb_base64ImgRegisterToS3(event);
                      reg_convertFigureTagRemove('thrNoFormulaEditor' + ordinalNum);
                      removeRedBoxValidAll(event);
                    }}
                    onClick={() => reg_dressYellowBox()}
                    onMouseDown={() => {
                  ...
                  <div
                    className='multiChoiceImgAddBtn'
                    onClick={(event) => {
                      multiChoiceImgAdd('thrNoFormulaEditor' + ordinalNum, event);
                    }}></div>
                </div>
                <div className='multiChoiceWrap'>
                  <div
                    id={'fourNoFormulaEditor' + ordinalNum}
                    contentEditable='true'
                    spellCheck={false}
                    className='multiChoiceView contentEditClass onlyEdit multi'
                    onKeyDown={(event) => {
                    ...
                    onKeyUp={(event) => {
                      ...
                      reg_nbComplie(event);
                      nb_base64ImgRegisterToS3(event);
                      reg_convertFigureTagRemove('fourNoFormulaEditor' + ordinalNum);
                      removeRedBoxValidAll(event);
                    }}
                    onClick={() => reg_dressYellowBox()}
                    onMouseDown={() => {
                  ...
                  <div
                    className='multiChoiceImgAddBtn'
                    onClick={(event) => {
                      multiChoiceImgAdd('fourNoFormulaEditor' + ordinalNum, event);
                    }}></div>
                </div>
                <div className='multiChoiceWrap'>
                  <div
                    id={'fifNoFormulaEditor' + ordinalNum}
                    contentEditable='true'
                    spellCheck={false}
                    className='multiChoiceView contentEditClass onlyEdit multi'
                    onKeyDown={(event) => {
                    ...
                    onKeyUp={(event) => {
                      ...
                      reg_nbComplie(event);
                      nb_base64ImgRegisterToS3(event);
                      reg_convertFigureTagRemove('fifNoFormulaEditor' + ordinalNum);
                      removeRedBoxValidAll(event);
                    }}
                    onClick={() => reg_dressYellowBox()}
                    onMouseDown={() => {
                  ...
                  <div
                    className='multiChoiceImgAddBtn'
                    onClick={(event) => {
                      multiChoiceImgAdd('fifNoFormulaEditor' + ordinalNum, event);
                    }}></div>
                </div>
                <div className='hide'>
                  &#9312; <textarea className='marginFive' id='firNo' name={'mathContents[' + idx + '].firNo'} defaultValue={firNo}></textarea>
                  <br />
                  &#9313; <textarea className='marginFive' id='secNo' name={'mathContents[' + idx + '].secNo'} defaultValue={secNo}></textarea>
                  <br />
                  &#9314; <textarea className='marginFive' id='thrNo' name={'mathContents[' + idx + '].thrNo'} defaultValue={thrNo}></textarea>
                  <br />
                  &#9315; <textarea className='marginFive' id='fourNo' name={'mathContents[' + idx + '].fourNo'} defaultValue={fourNo}></textarea>
                  <br />
                  &#9316; <textarea className='marginFive' id='fifNo' name={'mathContents[' + idx + '].fifNo'} defaultValue={fifNo}></textarea>
                  <br />
                </div>
              </div>
            </div>
            ...
            <div id='ansSolOptBox' className='ansSolOptBox marginTen multi'>
              ...
              <div>
                ...
                <div
                  id={'answerFormulaEditor' + ordinalNum}
