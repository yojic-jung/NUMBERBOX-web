                ...
                {isUpdtMode && <>
                    <tr>
                        <td colSpan={2}>
                            ...
                            <div id="updateResouceClose" className='closeBtn2' onClick={()=>{document.getElementById("updateResouce").classList.add("hide")}}>X</div>    
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td><span>대표 이미지</span><sup>(선택)</sup></td>
                        <td className='relative'>
                            ...
                            <div className='regResourceDesc'>대표 이미지를 설정하지 않는 경우<br/>ppt의 첫번째 슬라이드가 대표이미지로 지정됩니다.</div>
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="confirmBoxScreen" className='confirmBoxScreen hide'>
                <div id="confirmBox" className='confirmBox'>
                    ...
                    <div className='alignCenter'>
                        <span id="confirmBoxCnclBtn" className='confirmBoxCnclBtn' onClick={()=>{document.getElementById("confirmBoxScreen").classList.add("hide")}}>취소</span>
                        <span id="confirmBoxBtn" className='confirmBoxBtn' onClick={()=>{resourceUpdate()}}>확인</span>
                    </div>
                </div>
            </div>
