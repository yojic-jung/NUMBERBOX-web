...
return (
    ...
    <Helmet>
        ...
        <meta property='og:description' content='N명의수학' />
    </Helmet>
    <BrowserView>
        ...
        <MobileView>
            <div className='relative'>
                ...
                <div className='js-container-inner mobile'>
                    ...
                    <span className='fontEmphasis'>수학 문제 만들기</span>, <span className='fontEmphasis'>문제 공유 서비스</span>,<br/>
            ...
            <div className='mainSubRootDiv2 mobile'>
                <div className='mainSubDiv2Title mobile'>나의 제작 문제 및 변형 문제 만들기</div>
                ...
                <div className='mainSubDiv2Desc mobile'>
                    ...
                    <div>
                        ...
                        <div className='mainSubDescContents mobile'>
                            N명의 수학에서 제공하는 모든 문제는 완성된 원본 뿐만 아니라
                            해설이 포함된 편집본까지 함께 제공되어 사용자가 수정하여 새로운 변형문제로 만들어 낼 수 있습니다.<br/>
                        </div>
                    </div>
