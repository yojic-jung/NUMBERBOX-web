    ...
    <>
      ...
      <BrowserView>
        <div className='mainDiv'>
          <div className='mainImgBox first'>
            <img className='mainImgUI' src={main1} alt='' />
          </div>
          <div className='mainImgBox second'>
            <img className='mainImgUI' src={main2} alt='' />
          </div>
          <div className='mainImgBox third'>
            <img className='mainImgUI' src={main3} alt='' />
          </div>
        ...
        <div className='relative'>
          ...
          <div className='js-container-inner'>
            <div className='mainSubTitle1'>
              N명의 공유플랫폼, &nbsp;&nbsp;&nbsp;
              <span className='mainSubTitileName'>
                "N명<span className='mainSubTitileName2'>의</span>수학"
              </span>
            </div>
            <div className='mainSubDesc2'>지금 N명의 수학을 누려보세요!</div>
          </div>
        </div>
        ...
        <div className='mainSubRootDiv1'>
          <div className='mainSubDiv1'>
            ...
            <div className='mainSubBox first'>
              <img className='mainImgUI' src={mainSubDocsMake} alt='' />
            </div>
          </div>
        </div>
        <div className='mainSubRootDiv2'>
          ...
          <div className='mainSubDiv2'>
            ...
            <div className='mainSubBox second'>
              <img className='mainImgUI' src={mainSubConMake2} alt='' />
            </div>
          </div>
        ...
        <div className='mainSubRootDiv4'>
          <div className='mainSubDiv3'>
            ...
            <div className='relative alignRight'>
              ...
              <div className='mainSubBox second'>
                <img className='mainImgUI' src={mainResourceMake} alt='' />
              </div>
            </div>
          </div>
        </div>
      ...
      <MobileView>
        <div className='relative'>
          ...
          <div className='js-container-inner mobile'>
            ...
            <div className='mainSubDesc2 mobile'></div>
          </div>
        </div>
        <div className='pcDescDiv'>[PC버전]에서 서비스 제공중입니다.</div>
        <div className='mainSubRootDiv1 mobile'>
          <div className='mainSubDiv1 mobile'>
            ...
            <div className='mainSubBox first mobile'>
              <img className='mainImgUI' src={mainSubDocsMake} alt='' />
            </div>
          </div>
        </div>
        ...
        <div className='mainSubDiv3 mobile'>
          <div className='mainSubDivWrap3'>
            <div>
              ...
              <div className='mainSubDesc'>
                사용자가 제작한 수학문제를 한글파일(hwp)로
                <br />
                변환하여 다운 받을 수 있으며,
                <br />
                한글파일로 만들어진 문제를 업로드하여
                <br />
